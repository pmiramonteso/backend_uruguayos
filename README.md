...
git clone https://github.com/pmiramonteso/backend_uruguayos.git

Ingresa al directorio del proyecto:
cd backend_uruguayos
...
Levanta la aplicación Angular que esta en el repositorio: https://github.com/pmiramonteso/frontend_uruguayos.git
cd frontend_uruguayos
ng serve -o
